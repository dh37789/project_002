...
<body>
  <div id="page-container" class="side-scroll side-trans-enabled sidebar-o main-content-narrow sidebar-inverse">
<tiles:insertAttribute name="header"></tiles:insertAttribute>
	<tiles:insertAttribute name="left"></tiles:insertAttribute>
	<main id="main-container">
	<c:if test="${requestScope['javax.servlet.forward.servlet_path'] eq '/main/admin.do'}">
			<tiles:insertAttribute name="content"></tiles:insertAttribute>
	</c:if>
	<c:if test="${requestScope['javax.servlet.forward.servlet_path'] eq '/join/loginCheck.do'}">
			<tiles:insertAttribute name="content"></tiles:insertAttribute>
	</c:if>
	<c:if test="${requestScope['javax.servlet.forward.servlet_path'] ne '/main/admin.do' && requestScope['javax.servlet.forward.servlet_path'] ne '/join/loginCheck.do'
