...
$(function(){
	...
	$('#btnIntroduce').click(function(){
		if(eval('${empty memberInfo.mem_selfinfo}')){
	    	...
	    	location.href = "${pageContext.request.contextPath}/freProfile/selfInfoBeforeView.do?mem_id=${USER_LOGININFO.mem_id }";
		}
    });
	...
	$('#crawling').click(function(){
		location.href = "${pageContext.request.contextPath}/freProfile/crawling.do?mem_id=${USER_LOGININFO.mem_id }"
	})
...
<div class="content">
					...
					<button type="button" class="btn btn-sm btn-rounded btn-alt-secondary float-right" id="btnPortfolio" name="btnPortfolio">업데이트 하기</button>
								&nbsp; 포트폴리오
					</h2>
...
<%--                                 	<c:if test="${portInfo.pofile_status eq 'y' || null}"> --%>
					...
					<button type="button" class="btn btn-sm btn-rounded btn-alt-secondary float-right" id="technique" name="technique">업데이트 하기</button>
						&nbsp; 보유기술
					</h2>
                    ...
                    <div class="row items-push">
                        <div class="col-md-8 col-xl-12">
							...
							<table class="table table-bordered table-vcenter" id="tech_table">
								...
								<tbody id="tech_tbody" style="background-color: window;">
		...
		<!-- 											name="textType"> -->
					...
					<button type="button" class="btn btn-sm btn-rounded btn-alt-secondary float-right" id="btnSpec" name="btnSpec">업데이트 하기</button>
							&nbsp; 경력ㆍ학력ㆍ자격증
					</h2>
