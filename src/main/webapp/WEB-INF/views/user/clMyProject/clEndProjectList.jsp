...
$(function(){
	$('tr:gt(0)').click(function(){
		...
		$(location).attr('href','${pageContext.request.contextPath}/clMyProject/clEndPrView.do?pr_num='+pr_num);
	})
})
</script>
<body>
...
<h2 class="content-heading">완료된 프로젝트</h2>
   <div class="block-content">
      ...
      <c:if test="${fn:length(clEndPrList) eq 0}" >
      ...
      <td>
           ...
           <c:forEach items="${clEndPrList }" var="endProject">
           <tbody align="center">
               <tr>
       ...
       <div class="row justify-content-center float-right">
		<form class="form-inline" action="${pageContext.request.contextPath}/clMyProject/clEndPrList.do" method="post">
