...
$(function(){
	$('#rank').val('${workInfo.work_priority}');
	$('#time').val('${workInfo.work_time}');
	$('#title').val('${workInfo.work_title}');
	var startday = '${workInfo.work_start}'.split(' ');
	$('#start').val(startday[0]);
	var endday = '${workInfo.work_end}'.split(' ');
	$('#end').val(endday[0]);
	$('#order').val('${workInfo.work_char_id}');
	$('#orderWork').val('${workInfo.work_order}');
	$('#progress').val('${workInfo.work_progress}')
    ...
    $('#boardEdit').click(function(){
	    ...
	    .then(function(result){ 
				if (result) {
					...
					$('#form').append('<input type="hidden" name="work_num" value="${workInfo.work_num}">');
...
<nav class="breadcrumb bg-white push"> 
	...
	<span class="breadcrumb-item"> 
		<a href="${pageContext.request.contextPath }/projectWork/workList.do">프로젝트 일감</a> 
	</span>
	<span class="breadcrumb-item"> 
		<a>수정</a> 
	</span>
 ...
 <!-- CKEditor (js-ckeditor-inline + js-ckeditor ids are initialized in Codebase() -> uiHelperCkeditor()) -->
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath }/projectWork/workEdit.do" method="post"
	...
	<div class="block">
	    ...
	    <div class="block-content">
               ...
               <div class="row">
                   ...
                   <div class="col-11">
                       <input id="title" name="work_title" type="text" class="form-control" >
                   </div>
               </div>
            </div>
	        ...
	        <div class="form-group row">
	            ...
	            <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input id="start" type="date" class="js-datepicker form-control" id="datepicker1" name="work_start" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd">
                    </div>
                    <div class="col-6">
                        <input id="end" type="date" class="js-datepicker form-control" id="datepicker2" name="work_end" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd">
                    </div>
                </div>
	            </div>
            </div>
	        <div class="form-group row">
	            ...
	            <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select class="form-control" id="orderWork" name="work_order">
                            	<option></option>
	            ...
	            <div class="form-group row">
		            ...
		            <div class="col-5">
	                    <input type="text" class="form-control" id="time" name="work_time">
	                </div>
