...
<body>
<form class="form-horizontal" action="${pageContext.request.contextPath}/clProfile/updateSelfInfo.do" method="post">
	<div class="content">
		<!-- 자기소개 -->
			...
			<div class="col-md-8 col-xl-12">
				...
				<br><br>
						<div class="btn-wrapper pull-right">
							...
							<button type="submit" class="btn btn-primary min-width-125" id="btnEdit" name="btnEdit">등록 완료</button>
						</div>
						<br><br><br>
