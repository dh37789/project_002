...
$(function(){
	...
	$('#fileDelete').click(function(){
		$.ajax({
	         ...
	         url:'${pageContext.request.contextPath}/clProfile/deleteMemPic.do',
...
<body>
	<form class="form-horizontal" id="updateMember" role="form" method="post" action="${pageContext.request.contextPath}/clProfile/updateInfo.do" enctype="multipart/form-data">
