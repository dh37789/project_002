...
$(function(){
	...
	var cols = [{ data: 'attribute', type: 'text', width: 150},
                { data: 'english', type: 'text', width: 200},
                { data: 'type', type: 'text', width: 200},
                { data: 'length', type: 'text', width: 200},
                { data: 'explain', type: 'text', width: 200},
        ...
        var hTable = new Handsontable(table, {
            ...
            columns: cols,
            rowHeaders: true,
            colHeaders: ['표준속성명','표준영문명','타입','길이','설명','비고'],
            colWidths: 120,
            rowHeights: 23,
            autoRowSize: false,
            autoColSize: true,
