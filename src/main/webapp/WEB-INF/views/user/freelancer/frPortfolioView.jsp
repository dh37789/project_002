...
$(function(){
	...
	$('#btnBefore').click(function(){
		location.href = "${pageContext.request.contextPath}/freelancer/freelancerView.do?mem_id=${mem_id }";
	})
                    ...
                    <div class="col-md-12">
                            <div class="block block-themed">
                                ...
                                <div class="block-content">
                                    <p>&nbsp <img src="/files/${portInfo.pofile_save_name}" alt="pic1" width="300" height="250"></p>
                                    <p><a class="badge badge-warning">카테고리</a>&nbsp <c:if test="${portInfo.po_cate_num eq '1' }">웹</c:if>
                                    ...
                                    <p><a class="badge badge-warning">설명</a>&nbsp ${portInfo.po_content }</p>
                                    <p><a class="badge badge-warning">참여 기간</a>&nbsp ${fn:substring(portInfo.po_start, 0, 7)} ~ ${fn:substring(portInfo.po_end, 0, 7)}</p>
                                    <p><a class="badge badge-warning">참여율</a>&nbsp ${portInfo.po_percent }</p>
<!--                                     <p><a class="badge badge-primary"">이미지</a>  -->
									<p><a class="badge badge-warning">관련기술</a>&nbsp<c:if test="${portInfo.po_tech eq '22'}">PhotoShop</c:if> 
