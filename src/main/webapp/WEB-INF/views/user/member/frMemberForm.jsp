...
<script src="${pageContext.request.contextPath }/assets/js/pages/be_forms_validation.js?ver=1"></script>
...
$(function(){
	...
	$('#memberForm').submit(function(){
	  ...
	  var ftype_num = $('input:radio[name="ftype_num"]:checked').val();
	  ...
	  $('input[name=ftype_num]').val(ftype_num);
...
<body>
	<div class="content">
		...
		<h2 class="content-heading">Freelancer 회원가입</h2>
		<div class="block">
				...
				<div class="row justify-content-center py-20">
					<div class="col-xl-7">
						...
						<form id="memberForm" class="js-validation-bootstrap" action='${pageContext.request.contextPath }/member/insertMember.do' method="post">
							...
							<div class="form-group row">
								...
								<div class="col-lg-6">
									<input type="text" class="form-control" id="val-phoneus"
										name="val-phoneus" placeholder="전화번호를 입력해주세요.('-'포함해서 입력)">
							...
							<div class="form-group row">
								...
								<div class="col-lg-6">
									<input type="text" class="form-control" id="val-fax"
										name="val-fax" placeholder="팩스번호를 입력해주세요.('-'포함해서 입력)">
							...
							<div class="form-group row">
								<label class="col-lg-4 col-form-label" for="ftype_num">개발분야
									<span class="text-danger">*</span>
								</label>
								<div class="col-lg-6">
									<input type="radio" name="ftype_num" value="0" id="pro"/> 개발
									<input type="radio" name="ftype_num" value="1" id="design"/> 디자인
								</div>
							</div>
							
							<input type="hidden" class="form-control" id="iden_num" name="iden_num" value="2">
