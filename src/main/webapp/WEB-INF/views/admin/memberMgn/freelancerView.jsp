...
$(function(){
	$('.freelancerList').click(function(){
		$(location).attr('href', '${pageContext.request.contextPath}/memberMgn/freelancerMgn.do');
	});
	
	$('#updateMember').submit(function(){
		$(location).attr('href','${pageContext.request.contextPath}/memberMgn/updateFreelancer.do');	
	});	
...
<nav class="breadcrumb bg-white push">
	...
	<span class="breadcrumb-item">
		<a href="${pageContext.request.contextPath }/memberMgn/freelancerMgn.do">프리랜서</a>
	</span> 
	<span class="breadcrumb-item">
		<a>상세정보</a>
	</span> 
...
<div class="col-md-10 justify-content-center in row">
	<form class="form-horizontal" id="updateMember" role="form" method="post" action="${pageContext.request.contextPath}/memberMgn/updateFreelancer.do">
		<input type="hidden" name="mem_id" value="${memberInfo.mem_id }">						
						<div class="block text-center" id="mem_profile" style="width:800px;padding : 20px; margin-left : 300px; text-align: center;">
				    	...
				    	<div class="col-xl-13 text-right">
				        	<button type="submit" class="btn btn-rounded btn-noborder btn-warning min-width-50 mb-10 btn" id="freelancerUpdate" name="updateMember" style="margin-left: 40px;">수정</button>
				        	<button type="button" class="btn btn-rounded btn-noborder btn-success min-width-50 mb-10 freelancerList" name="freelancerList">목록</button>
				        </div>    
		</form>		
		</div>
</body>
