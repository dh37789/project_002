...
<script type='text/javascript'>
	$(function(){
		$('table tr:gt(0)').click(function(){
			...
			$(location).attr('href','${pageContext.request.contextPath}/board/aboardView.do?bo_num='+bo_num+'&rnum='+rnum);
		});
...
<nav class="breadcrumb bg-white push"> 
	...
	<span class="breadcrumb-item active"> 
		<a href="${pageContext.request.contextPath }/board/aboardList.do?currentPage=1">자유게시판</a> 
	</span> 
</nav>
