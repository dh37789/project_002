...
<script type='text/javascript'>
	$(function(){
		$('table tr:gt(0)').click(function(){
			...
			$(location).attr('href','${pageContext.request.contextPath}/notice/anoticeView.do?no_num='+no_num+'&rnum='+rnum);
...
<nav class="breadcrumb bg-white push"> <a class="breadcrumb-item">게시판 관리</a> <span
		class="breadcrumb-item active"> <a href="${pageContext.request.contextPath }/notice/anoticeList.do?currentPage=1">공지사항</a> </span> </nav>
    ...
    <h2 class="content-heading">공지사항 <small>Notice</small></h2>
		...
		<button type="button" id="new" class="btn btn-sm btn-primary">글 작성</button>
		${paging }
	<form action="${pageContext.request.contextPath }/notice/anoticeList.do" method="post" class="form-inline pull-right">
		...
		<button id="search" type="submit" class="btn btn-primary form-control">검색</button>
	</form>
	</div>
	<div>
	</div>
